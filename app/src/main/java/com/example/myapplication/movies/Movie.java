...
public class Movie {
    ...
    public static List<Movie> GetList(Context context) {
        ...
        // Đường dẫn của video trên Firebase Storage
        String videoPath = "gs://doancuoiki-5c77c.appspot.com/Phim/[Ep 025] Nguy hiểm_ Mặt nạ sư tử - Nobita bỏ nhà đi bụi.mp4";
        movie.setUrl(videoPath);

        videoPath = "gs://doancuoiki-5c77c.appspot.com/Phim/titansss1.mp4";
        movie.setUrl(videoPath);
